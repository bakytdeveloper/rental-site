            ...
            <Card className="admin-contacts__filters-card">
                <Card.Body className="admin-contacts__filters-card-body">
                    <Row>
                        ...
                        <Col md={3}>
                            <Form.Group className="admin-contacts__form-group">
                                <Form.Label className="admin-contacts__form-label">Priority</Form.Label>
                                <Form.Select
                                    value={filters.priority}
                                    onChange={(e) => handleFilterChange('priority', e.target.value)}
                                    className="admin-contacts__form-select"
                        ...
                        <>
                            <Table responsive className="admin-contacts__table">
                                ...
                                <tr>
                                    ...
                                    <th className="admin-contacts__table-header">Priority</th>
                                ...
                                {filteredContacts.map(contact => (
                                    <tr key={contact._id} className="admin-contacts__table-row">
                                        ...
                                        <td className="admin-contacts__table-cell">{getPriorityBadge(contact.priority)}</td>
                                        <td className="admin-contacts__table-cell">
                            ...
                            <Row>
                                ...
                                <Col md={6}>
                                    <div className="admin-contacts__detail-section">
                                        ...
                                        <div className="admin-contacts__detail-item">
                                            <strong className="admin-contacts__detail-label">Priority:</strong>
                                            <div className="admin-contacts__priority-actions">
                                                {getPriorityBadge(selectedContact.priority)}
                                                <div className="admin-contacts__priority-buttons">
                                                    {['low', 'medium', 'high'].map(priority => (
                                                        <Button
                                                            key={priority}
                                                            size="sm"
                                                            variant={selectedContact.priority === priority ? 'primary' : 'outline-primary'}
                                                            onClick={() => updateContactPriority(selectedContact._id, priority)}
                                                            className="admin-contacts__priority-btn"
                                                        >
                                                            {priority}
                                                        </Button>
                                                    ))}
